...
// Generated Thu, 05 Dec 2024 15:36:02 GMT
...
namespace ACTOR
{
	...
	static void TELEPORT_ACTOR_WITH_HEADING(Actor actor, float x, float z, float heading, BOOL p5, BOOL p6, BOOL p7) { invoke<Void>(0xE4DE507C, actor, x, z, heading, p5, p6, p7); } // 0xE4DE507C
	...
	static BOOL CAN_ACTOR_HOGTIE_TARGET(Actor actor, Actor actor2) { return invoke<BOOL>(0x1AA3A0C0, actor, actor2); } // 0x1AA3A0C0
	...
	static int IS_PLAYER_CONTROLLABLE() { return invoke<int>(0x9613C2D0); } // 0x9613C2D0
	static BOOL IS_PLAYER_IN_COMBAT(Any p0) { return invoke<BOOL>(0x6576AD43, p0); } // 0x6576AD43
	static BOOL IS_PLAYER_IN_COMBAT_WITHIN(float p0) { return invoke<BOOL>(0x48B7C279, p0); } // 0x48B7C279
	...
	static int SET_PLAYER_CURRENT_NOTORIETY(float p0) { return invoke<int>(0x4B0D6152, p0); } // 0x4B0D6152
	static int SET_PLAYER_CURRENT_HONOR(float p0) { return invoke<int>(0x4D918005, p0); } // 0x4D918005
	...
	static void SET_PLAYER_DEADEYE_POINTS(Actor actor, Any p1, Any p2) { invoke<Void>(0x50D8C840, actor, p1, p2); } // 0x50D8C840
	...
	static BOOL IS_ACTOR_REACTING(Any p0) { return invoke<BOOL>(0xBFD6AE3D, p0); } // 0xBFD6AE3D
	...
	static int IS_ACTOR_HANDSUP(Any p0) { return invoke<int>(0xA5A24484, p0); } // 0xA5A24484
...
namespace ACTORSET
{
	...
	static void ADD_ACTORSET_MEMBER(ActorSet actorSet, int actor) { invoke<Void>(0xE09DB6C1, actorSet, actor); } // 0xE09DB6C1
	static void REMOVE_ACTORSET_MEMBER(ActorSet actorSet, int actor) { invoke<Void>(0xD637E449, actorSet, actor); } // 0xD637E449
	static BOOL IS_ACTOR_IN_ACTORSET(ActorSet actorSet, int actor) { return invoke<BOOL>(0xC6FE68DF, actorSet, actor); } // 0xC6FE68DF
	...
	static BOOL GET_ACTORSET_SIZE(ActorSet actorSet) { return invoke<BOOL>(0xA24F4799, actorSet); } // 0xA24F4799
}
...
namespace AI_ANIMAL
{
	...
	static int ANIMAL_SPECIES_GRINGO_LOAD_ALL() { return invoke<int>(0xBFB65BE8); } // 0xBFB65BE8
	...
	static int ANIMAL_ACTOR_GET_GRABBED_BY(Any p0, Any p1) { return invoke<int>(0x57DF8CD0, p0, p1); } // 0x57DF8CD0
}
...
namespace AI_MISC
{
	...
	static void SET_ACTORS_HORSE(Actor actor, Actor mount) { invoke<Void>(0xCFFDF09D, actor, mount); } // 0xCFFDF09D
...
namespace AUDIO
{
	...
	static int PLAY_SOUND_FROM_POSITION_INITPARAMS(Any p0, float p1, float p2, float p3, Any p4, Any p5, Any p6) { return invoke<int>(0x19E5CF85, p0, p1, p2, p3, p4, p5, p6); } // 0x19E5CF85
...
namespace BUILTIN
{
	...
	static int START_NEW_SCRIPT(const char* scriptName, int p1) { return invoke<int>(0x3F166D0E, scriptName, p1); } // 0x3F166D0E
...
namespace CAMERA
{
	...
	static int IS_CURRENT_CAMERA_CHANNEL_TRANSITIONING(Any p0) { return invoke<int>(0x9A4CD54B, p0); } // 0x9A4CD54B
	...
	static void SET_CAMERA_POSITION(Cam camera, float x, float y, float z) { invoke<Void>(0x0B12CD8C, camera, x, y, z); } // 0x0B12CD8C
	...
	static void SET_CAMERA_ORIENTATION(Cam camera, float x, float y, float z, BOOL p4) { invoke<Void>(0x486F4461, camera, x, y, z, p4); } // 0x486F4461
...
namespace CORE
{
	...
	static float _GET_VECTOR_HEADING_DEGS(float* p0) { return invoke<float>(0x9C40E671, p0); } // 0x9C40E671
	...
	static int _TRANSFORM_WORLD_TO_SCREEN(Any p0, float* p1, float* p2) { return invoke<int>(0xBB3CDF72, p0, p1, p2); } // 0xBB3CDF72
	...
	static BOOL IS_BUTTON_DOWN(int controller, int control, Any p2, Any p3) { return invoke<BOOL>(0xC3297B50, controller, control, p2, p3); } // 0xC3297B50
	static BOOL IS_BUTTON_PRESSED(int controller, int control, Any p2, Any p3) { return invoke<BOOL>(0x7BCB3F15, controller, control, p2, p3); } // 0x7BCB3F15
	static BOOL IS_BUTTON_RELEASED(int controller, int control, Any p2, Any p3) { return invoke<BOOL>(0xB04EB731, controller, control, p2, p3); } // 0xB04EB731
...
namespace ENTITY
{
	...
	static int IS_ACTOR_IN_FIRE_VOLUME(Any p0) { return invoke<int>(0xE39E89BD, p0); } // 0xE39E89BD
...
namespace FACTION
{
	...
	static Any VERIFY_FACTION_ENUM() { return invoke<Any>(0x22424394); } // 0x22424394
	...
	static void SET_FACTIONS_STATUS_ONE_WAY(Any p0) { invoke<Void>(0xD771AF0B, p0); } // 0xD771AF0B
	static void SET_FACTIONS_STATUS_TWO_WAY(Any p0) { invoke<Void>(0x4C28B11E, p0); } // 0x4C28B11E
	static void SET_AMBIENT_FACTIONS_STATUS_TWO_WAY(Any p0) { invoke<Void>(0x6118212B, p0); } // 0x6118212B
	static Any RESET_FACTIONS_STATUS_TWO_WAY(Any p0) { return invoke<Any>(0x902781BF, p0); } // 0x902781BF
	static Any RESET_AMBIENT_FACTIONS_STATUS_TWO_WAY(Any p0) { return invoke<Any>(0xF9C5DC76, p0); } // 0xF9C5DC76
...
namespace GREETING
{
	static int SET_GREETING_CONTEXT(Any p0) { return invoke<int>(0x9953D4FC, p0); } // 0x9953D4FC
	static void SET_NON_VERBAL_GREETING_PROBABILITY(Any p0) { invoke<Void>(0x751809BB, p0); } // 0x751809BB
	static void SET_GREETING_LOOK_AT_ANGLE_DEFAULT(Any p0) { invoke<Void>(0x25A42C69, p0); } // 0x25A42C69
	static void SET_GREETING_LOOK_AT_ANGLE_ACTOR_SPECIFIC(Any p0, Any p1) { invoke<Void>(0x40121E4F, p0, p1); } // 0x40121E4F
	static void SET_GREETING_PROBABILITY_NPC_DEFAULT(Any p0) { invoke<Void>(0x86CB8CFB, p0); } // 0x86CB8CFB
	static void SET_GREETING_PROBABILITY_PLAYER_DEFAULT(Any p0) { invoke<Void>(0xD6AD0016, p0); } // 0xD6AD0016
	static void SET_GREETING_PROBABILITY_ACTOR_SPECIFIC(Any p0, Any p1) { invoke<Void>(0xDE84B637, p0, p1); } // 0xDE84B637
	static void SET_GREETING_MIN_TIME_INTERVAL(Any p0) { invoke<Void>(0x8C00C0BE, p0); } // 0x8C00C0BE
	static void SET_GREETING_MIN_TIME_INTERVAL_SAME_TARGET(Any p0) { invoke<Void>(0x7CC67B30, p0); } // 0x7CC67B30
	static void SET_GREETING_MAX_DISTANCE(Any p0) { invoke<Void>(0xD4ECD97D, p0); } // 0xD4ECD97D
	static void SET_GREETING_MIN_MOVEMENT_SPEED(Any p0) { invoke<Void>(0x826BB889, p0); } // 0x826BB889
	static void SET_GREETING_MAX_MOVEMENT_ANGLE(Any p0) { invoke<Void>(0x5473B93A, p0); } // 0x5473B93A
	static void SET_GREETING_ANIM_SIGNAL_TIMEOUT_DURATION(Any p0) { invoke<Void>(0x1B1EFCCB, p0); } // 0x1B1EFCCB
}
...
namespace HUD
{
	...
	static void SET_BLIP_BLINK(Blip blip, Any p1, Any p2, Any p3) { invoke<Void>(0x04B8C8C6, blip, p1, p2, p3); } // 0x04B8C8C6
	...
	static void SET_BLIP_HUDMAP_ONLY(Any p0, Any p1) { invoke<Void>(0x1E98AFEC, p0, p1); } // 0x1E98AFEC
	static void SET_BLIP_PAUSEMAP_ONLY(Any p0, Any p1) { invoke<Void>(0xFF3DB575, p0, p1); } // 0xFF3DB575
	static int GET_BLIP_IMPAIRMENT_MASK(Any p0) { return invoke<int>(0xD76F1E9A, p0); } // 0xD76F1E9A
	static void SET_BLIP_IMPAIRMENT_MASK(Any p0, Any p1) { invoke<Void>(0xBC05EBB3, p0, p1); } // 0xBC05EBB3
	static void SET_BLIP_MAX_DISTANCE(Any p0, Any p1) { invoke<Void>(0xCE79F8E2, p0, p1); } // 0xCE79F8E2
	static void SET_BLIP_MIN_DISTANCE(Any p0, Any p1) { invoke<Void>(0xFBA76D7E, p0, p1); } // 0xFBA76D7E
	static void _SET_BLIP_HEIGHT_ENABLED(Any p0, Any p1) { invoke<Void>(0x6077F3AE, p0, p1); } // 0x6077F3AE
	...
	static int GET_USER_DEFINED_WAYPOINT(Any p0) { return invoke<int>(0x82F63365, p0); } // 0x82F63365
	static int IS_USER_DEFINED_WAYPOINT_CLEARED() { return invoke<int>(0x34711B59); } // 0x34711B59
...
namespace INTERSECTION
{
	...
	static Any FIND_GROUND_INTERSECTION(Vector3* inCoords, float p1, Vector3* outCoords, int* p3) { return invoke<Any>(0x6AD8EEAF, inCoords, p1, outCoords, p3); } // 0x6AD8EEAF
	static Any FIND_GROUND_INTERSECTION_WITH_MATERIAL(Any p0) { return invoke<Any>(0x77964B0C, p0); } // 0x77964B0C
	...
	static Any GET_MATERIAL_AT_VECTOR(Any p0) { return invoke<Any>(0x5219B7D0, p0); } // 0x5219B7D0
...
namespace INVENTORY
{
	...
	static float ACTOR_GET_INV_AMMO(Actor actor, int ammoEnum, Any p2) { return invoke<float>(0xE224AC6F, actor, ammoEnum, p2); } // 0xE224AC6F
...
namespace OBJECT
{
	...
	static int CREATE_POINT_IN_LAYOUT(Any p0, Any p1, Any p2, Any p3, Any p4, Any p5, Any p6, Any p7) { return invoke<int>(0x44A34042, p0, p1, p2, p3, p4, p5, p6, p7); } // 0x44A34042
	...
	static int CREATE_GRINGO_IN_LAYOUT(Layout layout, const char* actorInLayout, const char* gringoPath, float positionX, float positionY, float positionZ, float orientationX, float orientationY, float orientationZ) { return invoke<int>(0x025C9845, layout, actorInLayout, gringoPath, positionX, positionY, positionZ, orientationX, orientationY, orientationZ); } // 0x025C9845
	...
	static Object CREATE_PROP_IN_LAYOUT(Layout layout, const char* actorInLayout, const char* propPath, Vector3* position, Vector3* orientation, BOOL p5) { return invoke<Object>(0xE351587D, layout, actorInLayout, propPath, position, orientation, p5); } // 0xE351587D
	...
	static int CREATE_SQUAD_IN_LAYOUT(Any p0, Any p1) { return invoke<int>(0xF7277A0F, p0, p1); } // 0xF7277A0F
	static int CREATE_FORMATION_IN_LAYOUT(Any p0, Any p1, Any p2) { return invoke<int>(0x91C6AC0E, p0, p1, p2); } // 0x91C6AC0E
	...
	static int FIND_VOLUME_IN_LAYOUT(Any p0, Any p1, Any p2, Any p3, Any p4, Any p5) { return invoke<int>(0xAC830865, p0, p1, p2, p3, p4, p5); } // 0xAC830865
	...
	static Any GET_OBJECT_POSITION(Object object, Vector3* position) { return invoke<Any>(0x31201B4C, object, position); } // 0x31201B4C
	...
	static int SET_OBJECT_POSITION(Object object, Vector3* position) { return invoke<int>(0xC5D796F8, object, position); } // 0xC5D796F8
	...
	static int SET_OBJECT_ORIENTATION(Object object, float x, float y, float z) { return invoke<int>(0xC8A4EE74, object, x, y, z); } // 0xC8A4EE74
	static int SNAP_OBJECT_TO_GROUND(Object object, float p1, float p2) { return invoke<int>(0xF437B3D9, object, p1, p2); } // 0xF437B3D9
	...
	static int ATTACH_OBJECTS(Object object1, Object object2, const char* locator, float p3, float p4, float p5, float p6, float p7, float p8, int p9) { return invoke<int>(0xE1421B42, object1, object2, locator, p3, p4, p5, p6, p7, p8, p9); } // 0xE1421B42
	...
	static Actor RESPAWN_PLAYER_ACTOR_IN_LAYOUT(Layout layout, Actor actor, const char* actorInLayout, int actorID, float x, float y, float z, float xRot, float yRot, float zRot, int unk0) { return invoke<Actor>(0x637E446B, layout, actor, actorInLayout, actorID, x, y, z, xRot, yRot, zRot, unk0); } // 0x637E446B
	...
	static int GET_ACTOR_ENUM_VARIATION_COUNT(int p0) { return invoke<int>(0xB50E95D7, p0); } // 0xB50E95D7
...
namespace PLAYSTATS
{
	static int PLAYSTAT_INT(Any p0, Any p1) { return invoke<int>(0x2547029C, p0, p1); } // 0x2547029C
	static Any PLAYSTAT_INT3(Any p0, const char* p1, int p2, const char* p3, int p4, const char* p5, int p6) { return invoke<Any>(0x6F6D942B, p0, p1, p2, p3, p4, p5, p6); } // 0x6F6D942B
	static Any PLAYSTAT_STRING(Any p0, Any p1) { return invoke<Any>(0x713B1D7F, p0, p1); } // 0x713B1D7F
	static Any PLAYSTAT_DEED_NAMED(Any p0, Any p1, Any p2, Any p3, Any p4) { return invoke<Any>(0x9C80A3A4, p0, p1, p2, p3, p4); } // 0x9C80A3A4
	...
	static Any PLAYSTAT_MP_COOP_COMPLETE(Any p0, Any p1, Any p2, Any p3, Any p4, Any p5) { return invoke<Any>(0x46C39437, p0, p1, p2, p3, p4, p5); } // 0x46C39437
}
...
namespace PROBE
{
	static int ROTATE_OBJECT_UPRIGHT_TO_GROUND(Any p0, float p1) { return invoke<int>(0x7080E24A, p0, p1); } // 0x7080E24A
...
namespace PROP
{
	...
	static int PROP_IS_VARIABLE_MESH_ENABLED(Any p0, Any p1) { return invoke<int>(0x375A33F0, p0, p1); } // 0x375A33F0
	static int PROP_ENABLE_VARIABLE_MESH(Any p0, Any p1, Any p2) { return invoke<int>(0x8287F8B3, p0, p1, p2); } // 0x8287F8B3
...
namespace RIDING
{
	static void SET_MOST_RECENT_MOUNT(Actor actor, Mount setMount) { invoke<Void>(0x00AF2CB0, actor, setMount); } // 0x00AF2CB0
	...
	static void REMOVE_HORSE_ACCESSORY(Actor actor, int accessory) { invoke<Void>(0x374D047A, actor, accessory); } // 0x374D047A
	static BOOL DOES_HORSE_HAVE_ACCESSORY(Actor actor, int accessory) { return invoke<BOOL>(0x75D4E33F, actor, accessory); } // 0x75D4E33F
	static Any ACCESSORIZE_HORSE(Actor actor, int accessory) { return invoke<Any>(0x6C939AA7, actor, accessory); } // 0x6C939AA7
...
namespace SPEECH
{
	static int CAN_ACTOR_ENUM_PLAY_SPEECH_CONTEXT(Any p0, Any p1) { return invoke<int>(0xD02757C1, p0, p1); } // 0xD02757C1
	static void REGISTER_ACTOR_SPEECH_CONTEXT(Any p0, const char* p1, Any p2, Any p3, Any p4, Any p5) { invoke<Void>(0x886E06C2, p0, p1, p2, p3, p4, p5); } // 0x886E06C2
	static const char* FINISH_REGISTERING_ACTOR_SPEECH_CONTEXTS() { return invoke<const char*>(0xB6839756); } // 0xB6839756
	static void REGISTER_NUM_SPEECH_CONTEXTS(Any p0) { invoke<Void>(0xCB139D15, p0); } // 0xCB139D15
	static int REGISTER_NUM_CONTEXT_TYPES() { return invoke<int>(0xF07F5E41); } // 0xF07F5E41
}
...
namespace TARGETING
{
	static int GET_ACTOR_UNDER_RETICLE(int* p0, Any p1, Any p2) { return invoke<int>(0x86BAAC6C, p0, p1, p2); } // 0x86BAAC6C
...
namespace TIME
{
	static Any GET_MINUTES_FROM_TIME_OF_DAY(Any p0) { return invoke<Any>(0x7C3D1193, p0); } // 0x7C3D1193
	...
	static Any CONVERT_TIME_OF_DAY_TO_INT() { return invoke<Any>(0x57FC0E16); } // 0x57FC0E16
	static Any SET_DAY(Any p0, Any p1) { return invoke<Any>(0x0EBBDC34, p0, p1); } // 0x0EBBDC34
	static int GET_HOUR(int time) { return invoke<int>(0x2765C37E, time); } // 0x2765C37E
	static int GET_MINUTE(int time) { return invoke<int>(0x1020BF6D, time); } // 0x1020BF6D
	static int GET_SECOND(int time) { return invoke<int>(0xBA8077CF, time); } // 0xBA8077CF
	static int GET_DAY(int time) { return invoke<int>(0x63D13FB0, time); } // 0x63D13FB0
	static void ADD_TIME(Any p0, Any p1, Any p2, Any p3, Any p4) { invoke<Void>(0xBA4FEEBC, p0, p1, p2, p3, p4); } // 0xBA4FEEBC
	static Any ADD_TIME_USING_TIME_OF_DAY(Any p0) { return invoke<Any>(0x2F7CB0E3, p0); } // 0x2F7CB0E3
	...
	static Any MAKE_TIME_OF_DAY_EX(Any p0) { return invoke<Any>(0x0E453CF0, p0); } // 0x0E453CF0
	static Any IS_LATER_THAN(Any p0) { return invoke<Any>(0x2DB3AC0F, p0); } // 0x2DB3AC0F
	...
	static void SET_TIME_OF_DAY(float time) { invoke<Void>(0xAD03186C, time); } // 0xAD03186C
...
namespace VEHICLES
{
	...
	static Any IS_ACTOR_JACKING_VEHICLE() { return invoke<Any>(0x1BA90C92); } // 0x1BA90C92
	static Any IS_ACTOR_INSIDE_VEHICLE(Any p0) { return invoke<Any>(0x12325AE7, p0); } // 0x12325AE7
	...
	static void STOP_VEHICLE(Actor vehicle) { invoke<Void>(0xC2232D29, vehicle); } // 0xC2232D29
	static void START_VEHICLE(Actor vehicle) { invoke<Void>(0xE4442AB2, vehicle); } // 0xE4442AB2
	static void ACCESSORIZE_VEHICLE_HORSES(Actor actor, int p1) { invoke<Void>(0xB12584C8, actor, p1); } // 0xB12584C8
	static int GET_NUM_DRAFT_POSITIONS(Actor actor, int p1) { return invoke<int>(0xD85CA776, actor, p1); } // 0xD85CA776
	static void ATTACH_DRAFT_TO_VEHICLE(Actor actor, Actor vehicle, int p2, BOOL p3) { invoke<Void>(0xB0A81226, actor, vehicle, p2, p3); } // 0xB0A81226
	...
	static BOOL IS_VEHICLE_ALLOWED_TO_DRIVE(Actor vehicle) { return invoke<BOOL>(0x1C391A44, vehicle); } // 0x1C391A44
	static void SET_VEHICLE_PASSENGERS_ALLOWED(Actor vehicle, BOOL allowed) { invoke<Void>(0xBD0C1BEA, vehicle, allowed); } // 0xBD0C1BEA
	static void SET_VEHICLE_EJECTION_ENABLED(Actor vehicle, BOOL enabled) { invoke<Void>(0x0ABD83C0, vehicle, enabled); } // 0x0ABD83C0
...
namespace WEAPON
{
	static int INIT_NATIVE_WEAPONENUM_PISTOL(Any p0, Any p1, Any p2) { return invoke<int>(0xBAC27559, p0, p1, p2); } // 0xBAC27559
	static int INIT_NATIVE_WEAPONENUM_RIFLE(Any p0, Any p1, Any p2) { return invoke<int>(0xA534CD14, p0, p1, p2); } // 0xA534CD14
	static int INIT_NATIVE_WEAPONENUM_REPEATER(Any p0, Any p1, Any p2) { return invoke<int>(0xA72B6620, p0, p1, p2); } // 0xA72B6620
	static int INIT_NATIVE_WEAPONENUM_SNIPERRIFLE(Any p0, Any p1, Any p2) { return invoke<int>(0x92FE3677, p0, p1, p2); } // 0x92FE3677
	static int INIT_NATIVE_WEAPONENUM_SHOTGUN(Any p0, Any p1, Any p2) { return invoke<int>(0xEA06907B, p0, p1, p2); } // 0xEA06907B
	static int INIT_NATIVE_WEAPONENUM_THROWN(Any p0, Any p1, Any p2) { return invoke<int>(0xE0DF7B3B, p0, p1, p2); } // 0xE0DF7B3B
	static int INIT_NATIVE_WEAPONENUM_THROWN_EXPLODING(Any p0, Any p1, Any p2) { return invoke<int>(0xA2597101, p0, p1, p2); } // 0xA2597101
	static int INIT_NATIVE_WEAPONENUM_BOW(Any p0, Any p1, Any p2) { return invoke<int>(0x2AD5D078, p0, p1, p2); } // 0x2AD5D078
	static int INIT_NATIVE_WEAPONENUM_MELEE(Any p0, Any p1, Any p2) { return invoke<int>(0xA6C4E59F, p0, p1, p2); } // 0xA6C4E59F
	static int INIT_NATIVE_WEAPONENUM_LASSO(Any p0, Any p1, Any p2) { return invoke<int>(0xF82711CC, p0, p1, p2); } // 0xF82711CC
	static int INIT_NATIVE_WEAPONENUM_TURRET(Any p0, Any p1, Any p2) { return invoke<int>(0x82609DC7, p0, p1, p2); } // 0x82609DC7
	static int INIT_NATIVE_WEAPONENUM_CANNON(Any p0, Any p1, Any p2) { return invoke<int>(0x628E3173, p0, p1, p2); } // 0x628E3173
	static int INIT_NATIVE_WEAPONENUM_AMMO(Any p0, Any p1) { return invoke<int>(0xCE5CCF2E, p0, p1); } // 0xCE5CCF2E
	...
	static int INIT_NATIVE_WEAPONENUM_CATEGORY() { return invoke<int>(0x01C7193C); } // 0x01C7193C
	static int FINALIZE_WEAPONENUM_CATEGORIES() { return invoke<int>(0x0A23A69C); } // 0x0A23A69C
	static void SET_WEAPONENUM_LOCKED(int weaponEnum, BOOL locked) { invoke<Void>(0x0E4B7A33, weaponEnum, locked); } // 0x0E4B7A33
	...
	static int RESOLVE_DLC_WEAPONENUM(Any p0) { return invoke<int>(0xD291A820, p0); } // 0xD291A820
	static int ADD_IDLEFX_TO_WEAPON(Any p0, Any p1, float p2, float p3, float p4) { return invoke<int>(0xF4641CF4, p0, p1, p2, p3, p4); } // 0xF4641CF4
}

namespace WEATHER
{
	static void SET_WEATHER(int weatherType, float transitionSpeed) { invoke<Void>(0x456D7F38, weatherType, transitionSpeed); } // 0x456D7F38
